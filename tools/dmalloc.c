...
#if MP_IDENT_SUPPORT
#ident "$Id: dmalloc.c,v 1.15 2001-08-23 22:18:17 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *dmalloc_id = "$Id: dmalloc.c,v 1.15 2001-08-23 22:18:17 graeme Exp $";
