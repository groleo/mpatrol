...
#if MP_IDENT_SUPPORT
#ident "$Id: dbmalloc.c,v 1.13 2001-08-23 22:18:17 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *dbmalloc_id = "$Id: dbmalloc.c,v 1.13 2001-08-23 22:18:17 graeme Exp $";
