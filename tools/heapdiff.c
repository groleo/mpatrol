...
#if MP_IDENT_SUPPORT
#ident "$Id: heapdiff.c,v 1.10 2001-08-23 22:18:17 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *heapdiff_id = "$Id: heapdiff.c,v 1.10 2001-08-23 22:18:17 graeme Exp $";
