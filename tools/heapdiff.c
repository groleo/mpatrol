...
#if MP_IDENT_SUPPORT
#ident "$Id: heapdiff.c,v 1.9 2001-08-01 22:36:22 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *heapdiff_id = "$Id: heapdiff.c,v 1.9 2001-08-01 22:36:22 graeme Exp $";
