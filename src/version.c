...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.38 2001-02-08 19:55:50 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *version_id = "$Id: version.c,v 1.38 2001-02-08 19:55:50 graeme Exp $";
