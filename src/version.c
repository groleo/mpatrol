...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.33 2000-12-18 22:20:46 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.3.2" /* library name and version */
