...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.1.1.1 1999-10-03 11:25:23 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.0" /* library name and version */
