...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.20 2000-04-10 19:45:52 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.1.4" /* library name and version */
