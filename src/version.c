...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.17 2000-03-17 00:33:12 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.1.2" /* library name and version */
