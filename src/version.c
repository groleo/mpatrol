...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.5 1999-10-15 00:12:03 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.2" /* library name and version */
