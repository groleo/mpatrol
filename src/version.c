...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.32 2000-11-22 23:22:56 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.3.1" /* library name and version */
