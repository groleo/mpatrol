...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.24 2000-06-18 10:01:35 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.2.2" /* library name and version */
