...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.9 1999-11-25 18:09:43 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.6" /* library name and version */
