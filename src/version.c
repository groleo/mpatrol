...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.35 2001-01-06 15:20:02 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.3.3" /* library name and version */
