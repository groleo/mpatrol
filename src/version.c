...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.51 2001-10-03 23:08:48 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *version_id = "$Id: version.c,v 1.51 2001-10-03 23:08:48 graeme Exp $";
