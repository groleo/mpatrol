...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.10 1999-11-29 20:15:50 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.7" /* library name and version */
