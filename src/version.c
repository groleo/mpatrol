...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.4 1999-10-13 21:22:30 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.1" /* library name and version */
