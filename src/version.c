...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.27 2000-07-12 00:26:06 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.2.5" /* library name and version */
