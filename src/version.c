...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.25 2000-06-26 23:19:44 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.2.3" /* library name and version */
