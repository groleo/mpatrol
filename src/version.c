...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.23 2000-06-01 21:37:17 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.2.1" /* library name and version */
