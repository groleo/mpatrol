...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.47 2001-08-23 22:42:34 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *version_id = "$Id: version.c,v 1.47 2001-08-23 22:42:34 graeme Exp $";
