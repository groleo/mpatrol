...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.31 2000-11-18 15:34:15 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.3.0" /* library name and version */
