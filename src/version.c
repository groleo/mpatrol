...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.6 1999-10-19 19:23:11 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.0.3" /* library name and version */
