...
#if MP_IDENT_SUPPORT
#ident "$Id: version.c,v 1.26 2000-06-29 19:45:10 graeme Exp $"
...
#define MP_VERSION "mpatrol 1.2.4" /* library name and version */
