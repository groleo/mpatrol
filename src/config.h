...
#if SYSTEM == SYSTEM_AIX || SYSTEM == SYSTEM_DYNIX || \
    SYSTEM == SYSTEM_FREEBSD || SYSTEM == SYSTEM_HPUX || \
    SYSTEM == SYSTEM_LINUX || SYSTEM == SYSTEM_NETBSD || \
    SYSTEM == SYSTEM_OPENBSD || SYSTEM == SYSTEM_UNIXWARE
...
#elif SYSTEM == SYSTEM_DRSNX || SYSTEM == SYSTEM_FREEBSD || \
 ...
 */
    ...
    SYSTEM == SYSTEM_DYNIX || SYSTEM == SYSTEM_FREEBSD || \
    SYSTEM == SYSTEM_HPUX || SYSTEM == SYSTEM_NETBSD || \
    SYSTEM == SYSTEM_OPENBSD || SYSTEM == SYSTEM_SINIX || \
    SYSTEM == SYSTEM_SOLARIS || SYSTEM == SYSTEM_UNIXWARE
