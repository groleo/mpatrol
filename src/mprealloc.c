...
#if MP_IDENT_SUPPORT
#ident "$Id: mprealloc.c,v 1.5 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mprealloc_id = "$Id: mprealloc.c,v 1.5 2001-08-23 22:42:33 graeme Exp $";
