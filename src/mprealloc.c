...
#if MP_IDENT_SUPPORT
#ident "$Id: mprealloc.c,v 1.9 2008-07-17 10:51:53 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mprealloc_id = "$Id: mprealloc.c,v 1.9 2008-07-17 10:51:53 groy Exp $";
