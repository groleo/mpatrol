...
#if MP_IDENT_SUPPORT
#ident "$Id: mprealloc.c,v 1.8 2008-07-16 13:17:33 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mprealloc_id = "$Id: mprealloc.c,v 1.8 2008-07-16 13:17:33 groy Exp $";
