...
#if MP_IDENT_SUPPORT
#ident "$Id: mprealloc.c,v 1.3 2001-02-08 21:16:38 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mprealloc_id = "$Id: mprealloc.c,v 1.3 2001-02-08 21:16:38 graeme Exp $";
