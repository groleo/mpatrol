...
#if MP_IDENT_SUPPORT
#ident "$Id: mprealloc.c,v 1.7 2007-04-26 11:27:55 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mprealloc_id = "$Id: mprealloc.c,v 1.7 2007-04-26 11:27:55 groy Exp $";
