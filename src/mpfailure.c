...
#if MP_IDENT_SUPPORT
#ident "$Id: mpfailure.c,v 1.5 2007-04-26 11:27:55 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpfailure_id = "$Id: mpfailure.c,v 1.5 2007-04-26 11:27:55 groy Exp $";
