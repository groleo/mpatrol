...
#if MP_IDENT_SUPPORT
#ident "$Id: mpfailure.c,v 1.6 2008-07-16 13:17:32 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpfailure_id = "$Id: mpfailure.c,v 1.6 2008-07-16 13:17:32 groy Exp $";
