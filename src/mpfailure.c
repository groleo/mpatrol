...
#if MP_IDENT_SUPPORT
#ident "$Id: mpfailure.c,v 1.3 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpfailure_id = "$Id: mpfailure.c,v 1.3 2001-08-23 22:42:33 graeme Exp $";
