...
#if MP_IDENT_SUPPORT
#ident "$Id: mpfailure.c,v 1.2 2001-02-05 22:58:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpfailure_id = "$Id: mpfailure.c,v 1.2 2001-02-05 22:58:33 graeme Exp $";
