...
#if MP_IDENT_SUPPORT
#ident "$Id: mpfailure.c,v 1.7 2008-07-17 10:51:53 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpfailure_id = "$Id: mpfailure.c,v 1.7 2008-07-17 10:51:53 groy Exp $";
