...
#if MP_IDENT_SUPPORT
#ident "$Id: mpmalloc.c,v 1.4 2001-08-01 21:31:51 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpmalloc_id = "$Id: mpmalloc.c,v 1.4 2001-08-01 21:31:51 graeme Exp $";
