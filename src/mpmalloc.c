...
#if MP_IDENT_SUPPORT
#ident "$Id: mpmalloc.c,v 1.5 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpmalloc_id = "$Id: mpmalloc.c,v 1.5 2001-08-23 22:42:33 graeme Exp $";
