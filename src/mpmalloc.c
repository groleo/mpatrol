...
#if MP_IDENT_SUPPORT
#ident "$Id: mpmalloc.c,v 1.6 2002-01-08 20:13:59 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpmalloc_id = "$Id: mpmalloc.c,v 1.6 2002-01-08 20:13:59 graeme Exp $";
