...
#if MP_IDENT_SUPPORT
#ident "$Id: mptrace.c,v 1.27 2001-10-03 23:11:45 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mptrace_id = "$Id: mptrace.c,v 1.27 2001-10-03 23:11:45 graeme Exp $";
