...
#if MP_IDENT_SUPPORT
#ident "$Id: mptrace.c,v 1.26 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mptrace_id = "$Id: mptrace.c,v 1.26 2001-08-23 22:42:33 graeme Exp $";
