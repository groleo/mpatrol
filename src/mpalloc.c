...
#if MP_IDENT_SUPPORT
#ident "$Id: mpalloc.c,v 1.25 2001-03-05 20:36:35 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpalloc_id = "$Id: mpalloc.c,v 1.25 2001-03-05 20:36:35 graeme Exp $";
