...
#if MP_IDENT_SUPPORT
#ident "$Id: mpalloc.c,v 1.40 2001-08-01 21:15:14 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpalloc_id = "$Id: mpalloc.c,v 1.40 2001-08-01 21:15:14 graeme Exp $";
