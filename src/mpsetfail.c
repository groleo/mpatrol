...
#if MP_IDENT_SUPPORT
#ident "$Id: mpsetfail.c,v 1.4 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpsetfail_id = "$Id: mpsetfail.c,v 1.4 2001-08-23 22:42:33 graeme Exp $";
