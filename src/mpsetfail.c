...
#if MP_IDENT_SUPPORT
#ident "$Id: mpsetfail.c,v 1.7 2008-07-16 13:17:33 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpsetfail_id = "$Id: mpsetfail.c,v 1.7 2008-07-16 13:17:33 groy Exp $";
