...
#if MP_IDENT_SUPPORT
#ident "$Id: mpsetfail.c,v 1.6 2007-04-26 11:27:56 groy Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *mpsetfail_id = "$Id: mpsetfail.c,v 1.6 2007-04-26 11:27:56 groy Exp $";
