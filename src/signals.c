...
#if MP_IDENT_SUPPORT
#ident "$Id: signals.c,v 1.25 2001-08-23 22:42:33 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *signals_id = "$Id: signals.c,v 1.25 2001-08-23 22:42:33 graeme Exp $";
