...
#if MP_IDENT_SUPPORT
#ident "$Id: profile.c,v 1.37 2001-12-05 22:38:31 graeme Exp $"
#else /* MP_IDENT_SUPPORT */
static MP_CONST MP_VOLATILE char *profile_id = "$Id: profile.c,v 1.37 2001-12-05 22:38:31 graeme Exp $";
